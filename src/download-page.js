    ...
    <div class="row">
      <div class="col-sm-8 col-sm-offset-2">
        <div class="col-sm-6 col-xs-9 text-xs-center">
          ...
          <h5 ><b>ABOUT US </b></h5>
          <a className="Inline" href="https://www.rentspree.com/about" target="_blank">About</a><font/>/
          ...
          <h5 ><b>RESOURCES </b></h5>
          <a className="Inline" href="html_images.asp" target="_blank">Screen Tenants</a><font/>/
          <a className="Inline" href="html_images.asp" target="_blank">Blog</a><font/>/            <a className="Inline" href="html_images.asp" target="_blank">Sitemap</a><font/>

          <h5 ><b>TALK TO US </b></h5>
          <a className="Inline" href="html_images.asp" target="_blank">Demo</a><font/>/
